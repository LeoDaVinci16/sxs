...
Un treball previ a la presa de mesures va consistir en representar el circuit d'aigua de torres i identificar els punts de mesura. Per fer-ho es van identificar les diferents bombes, consumidors i ramificacions. Aquests punts es van codificar amb un codi alfanumèric i estan representats a la Figura~\ref{fig:network}. els diferents punts, i se'ls atribueix un node d'origen (source) un de destí (target) i un valor de cabal.
...
Els punts de mesura seleccionats es detallen a la Taula~\ref{tab:taula_punts_at}. El cabal teòric s'ha calculat mitjançant l'equació \ref{eq:cabal_teoric} suposant que la velocitat de l'aigua és de 1 m/s. El cabal esperat s'ha estimat a partir de les mesures previes fetes amb el cabalímetre ultrasònic.


Combinant ambdues equacions, obtenim:
\begin{equation}
    Q = \frac{\pi \cdot D^2}{4} \cdot v = \frac{\pi \cdot D^2}{4} \, \text{[m}^3/\text{s]}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{llllll}
        \toprule
        \textbf{Source} & \textbf{Target} & \textbf{Codi} & \textbf{Diàmetre} & \textbf{Cabal calculat} & \textbf{Cabal esperat} \\
        \midrule
