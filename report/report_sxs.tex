...
A partir del planol del cicruit d'aigua de torres Figura~\ref{fig:network} s'ha definit una xarxa anàloga definida a partir de nodes i branques. Cada node representa un punt d'origen (bombes), destí (consumidors) o una ramificació. Les branques son les unions entre els diferents nodes i representen les pròpies canonades del circuit. Els punts de mesura situats a les canonades es defineixen pel nom de la branca.

Aquests punts es van codificar amb un codi numèric. Als diferents punts se'ls atribueix un node d'origen un de destí i un valor de cabal.
