...
Aquest dispositiu opera mitjançant la tecnologia d'ultrasons per temps de trànsit (transit-time), basada en la diferència de temps que experimenten dos senyals ultrasònics en propagar-se a favor i en contra del flux del fluid. Aquesta diferència temporal ($\Delta t$) és directament proporcional a la velocitat mitjana del fluid, i permet calcular el cabal volumètric amb elevada
...
Un treball previ a la presa de mesures va consistir en representar el circuit d'aigua de torres i identificar els punts de mesura. Per fer-ho es van trobar les diferents bombes, consumidors --majoritàriament intercanviadors-- i les diferents ramificacions.
...
Els punts de mesura seleccionats es detallen a la Taula~\ref{tab:taula_punts_at}. El cabal teòric s'ha calculat mitjançant les equacions \eqref{eq:area} i \eqref{eq:cabal_teoric} suposant que la velocitat de l'aigua és de $1 \text{ m/s}$. El cabal esperat s'ha estimat a partir de les mesures prèvies fetes amb el cabalímetre ultrasònic.
